 ...
 * 地锁 服务接口类
 */
public interface ParkingLockService extends BaseService {
	 ...
	 * @param parkingLock 新增的ParkingLock数据（如果无特殊需求，新增对象的主键值请保留为null）
	 * @param operator 操作人对象
	 * @return
	 */
	 ...
	 * @param parkingLock 更新的ParkingLock数据，且其主键不能为空
	 * @param operator 操作人对象
	 * @return
	 */
