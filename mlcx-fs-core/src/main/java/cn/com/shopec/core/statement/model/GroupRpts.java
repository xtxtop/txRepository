 ...
 * 集团汇总表 数据实体类
 */
public class GroupRpts extends Entity<String> {
	...
	// 时长平均值
	private Integer orderDurationAvg;
	// 金额平均值
	private Integer orderAmountAvg;
	//汇总开始时间
	...
	public Integer getOrderDurationAvg() {
		return orderDurationAvg;
	}
	public void setOrderDurationAvg(Integer orderDurationAvg) {
		this.orderDurationAvg = orderDurationAvg;
	}
	public Integer getOrderAmountAvg() {
		return orderAmountAvg;
	}
	public void setOrderAmountAvg(Integer orderAmountAvg) {
