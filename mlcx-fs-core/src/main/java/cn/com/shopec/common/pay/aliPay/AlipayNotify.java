...
public class AlipayNotify {
	...
	public static boolean verifyRefund(Map<String, String> params) {
		...
		boolean isSign = getSignVeryfyRefund(params, sign);
	...
	private static boolean getSignVeryfy(Map<String, String> Params, String sign) {
		...
		try {
			isSign = SignUtils.verify(preSignStr, sign);
		} catch (Exception e) {
     ...
     * @return 生成的签名结果
     */
	private static boolean getSignVeryfyRefund(Map<String, String> Params, String sign) {
    	//过滤空值、sign与sign_type参数
    	Map<String, String> sParaNew = AlipayCore.paraFilter(Params);
        //获取待签名字符串
        String preSignStr = AlipayCore.createLinkString(sParaNew);
