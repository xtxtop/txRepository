...
import cn.com.shopec.common.utils.httpClient.HttpProtocolHandler;
import cn.com.shopec.common.utils.httpClient.HttpRequest;
import cn.com.shopec.common.utils.httpClient.HttpResponse;
import cn.com.shopec.common.utils.httpClient.HttpResultType;


import cn.com.shopec.common.pay.common.MD5;
...
public class AlipaySubmit {
    ...
    public static String buildRequestAlipay(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp);
        List<String> keys = new ArrayList<String>(sPara.keySet());
