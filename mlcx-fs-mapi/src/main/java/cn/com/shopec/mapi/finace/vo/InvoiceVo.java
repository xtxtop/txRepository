...
public class InvoiceVo implements Serializable{
	...
	*/ 
	...
	public String[] getBizObjIds() {
		return bizObjIds;
	}

	public void setBizObjIds(String[] bizObjIds) {
		this.bizObjIds = bizObjIds;
	}
	...
	public String toString() {
		return "Invoice ["
		 ...
		 + ", bizObjIds = " + bizObjIds + ", orderAmount = " + orderAmount + ", orderTime = " + orderTime + ", orderTimeStart = " + orderTimeStart + ", orderTimeEnd = " + orderTimeEnd + ", invoiceTime = " + invoiceTime + ", invoiceTimeStart = " + invoiceTimeStart + ", invoiceTimeEnd = " + invoiceTimeEnd
