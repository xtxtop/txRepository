...
//		try{
//			request.getSession().setAttribute(WebConstant.SESSION_KEY_OF_LOGIN_SYS_USER, sysUser);
//			return true;
//		}catch(Exception e){
//			e.printStackTrace();
//		}
...
//		if(session != null) {
//			sysUser = (SysUser)session.getAttribute(WebConstant.SESSION_KEY_OF_LOGIN_SYS_USER); //从session中取已登录的系统人员用户对象
//		}
//		return sysUser;
//	}
