...
public class MonitorDataInterflowController extends BaseController {
	@Resource
	private MonitorDataInterflowService monitorDataInterflowService;

		// 交流列表展示
		@RequestMapping("/pageListMonitorDataInterflow")
		@ResponseBody
		public PageFinder<MonitorDataInterflow> pageListMonitoringData(@ModelAttribute("MonitorDataInterflow") MonitorDataInterflow monitorDataInterflow,
				Query query) throws ParseException {
			Query q = new Query(query.getPageNo(), query.getPageSize(), monitorDataInterflow);
			return monitorDataInterflowService.getMonitorDataInterflowPagedList(q);
		}
}
