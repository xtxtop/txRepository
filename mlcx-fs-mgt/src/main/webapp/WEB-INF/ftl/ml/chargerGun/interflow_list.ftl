...
<div class="container-fluid">
	<div class="search-input-wrapper">
		...
		<div class="search-input-content">
			...
			<!-- /.box-header -->
			<form class="form-horizontal" name="interflowSearchForm">
				<div class="seach-input-border-box">
					<div class="seach-input-details seach-input-details-change close-content clearfix">
						<div class="seach-input-item seach-input-item-change pull-left">
							<span>编号</span>
							<input type="text" class="form-control" id="interflowNo" name="interflowNo" placeholder="请输入监测数据编号">
						</div>
					...
					<div class="seacher-button-content">
						...
						<button type="button" class="btn-new-type" id="interflowSearchBt">确定</button>
					</div>
				</div>
			</form>
		</div>
	...
	<div class="row show-table-content">
		<div class="col-xs-12">
			...
			<div class="box">
				<div class="box-body">
					<table id="interflowList" class="table table-hover table-bettween-far" width="100%" border="1">
					</table>
				</div>
				<!-- /.box-body -->
			</div>
...
<script type="text/javascript">
	$(function() {
		require.config({
			paths: {
				"interflow": "res/js/ml/chargerGun/interflow_list"
			}
		});
		require(["interflow"], function(interflow) {
			interflow.init();
		});
	});
</script>