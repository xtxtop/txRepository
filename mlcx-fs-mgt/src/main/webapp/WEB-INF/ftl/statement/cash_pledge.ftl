...
border:1px solid rgba(127,127,127,0.05);
  ...
  <div class="container-fluid">
   <div class="search-input-wrapper">
     ...
     <!-- /.box-header -->
       <form name="cashPledgeSearchForm">
        ...
        <div class="seach-input-details seach-input-details-change close-content clearfix">
		        ...
		        <div class="seach-input-item seach-input-item-change pull-left">
		       	...
		       	<div class="seacher-button-content">
						...
						<button type="button" class="btn-new-type" id="cashPledgeSearch">确定</button>
					</div>
        </div><!-- /.box-body -->
         </form>
       </div><!-- /.box -->
      ...
      <div class="row show-table-content">
       ...
       <div class="box">
        <div class="box-body">
         <table id="cashPledge" class="table table-hover table-bettween-far" width="100%" border="1">
         </table>
        </div><!-- /.box-body -->
       </div><!-- /.box -->   
      </div><!-- /.col -->
    ...
    $(function(){
	  require.config({paths: {"cashPledge":"res/js/statement/cash_pledge"}});
		require(["cashPledge"], function (cashPledge){
			cashPledge.init();
		});  
	});
    $(function () {
