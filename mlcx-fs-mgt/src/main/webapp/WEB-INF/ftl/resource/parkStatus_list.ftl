...
<div class="container-fluid">
				...
				<div class="seach-input-border-box">
					<div class="seach-input-details seach-input-details-change close-content clearfix">
						<div class="seach-input-item seach-input-item-change pull-left">
							<span>编号</span>
							<input type="text" class="form-control" id="parkNo" name="parkNo" placeholder="请输入编号">
						</div>
						<div class="seach-input-item seach-input-item-change pull-left">
							<span>名称</span>
							<input type="text" class="form-control" id="parkName" name="parkName" placeholder="请输入名称">
						</div>
					...
					<div class="seacher-button-content">
						...
						<button type="button" class="btn-new-type" id="parkStatusSearchafter">确定</button>
					</div>
				</div>
				<!-- /.box-body -->
			</form>
	...
	<div class="row show-table-content">
		<div class="col-xs-12">
			...
			<div class="box">
				<div class="box-body">
					<table id="parkStatusList" class="table table-hover table-bettween-far" width="100%" border="1">
					</table>
				</div>
				<!-- /.box-body -->
			</div>
...
<script type="text/javascript">
	require.config({
		paths: {
			"parkStatus": "res/js/resource/parkStatus_list"
		}
	});
