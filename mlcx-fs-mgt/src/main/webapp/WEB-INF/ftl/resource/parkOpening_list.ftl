  ...
  <div class="container-fluid">
	<div class="search-input-wrapper">
      ...
      <div class="seach-input-border-box">
                ...
                <div class="seach-input-item pull-left">
                    <span>提交时间</span>
                    <input class="datepicker form-control" name="createTimeStart"  placeholder="请输入提交时间"  value="${today}"/>
                </div>
                <div class="seach-input-item pull-left">
                     <span>至</span>
                     <input class="datepicker form-control" name="createTimeEnd"  placeholder="请输入结束时间" />
                 </div>
         </div><!-- /.row -->
         			<div class="seacher-button-content">
						<button type="reset" class="btn-new-type">清空</button>
						<button type="button" class="btn-new-type" id="parkOpeningSearch">确定</button>
					</div>
        </div><!-- /.box-body -->
         </form>
       </div><!-- /.box -->
      ...
      <div class="row show-table-content">
       ...
       <div class="box">
        <div class="box-body">
         <table id="parkOpeningList" class="table table-hover table-bettween-far" width="100%" border="1">
         </table>
        </div><!-- /.box-body -->
       </div><!-- /.box -->   
      </div><!-- /.col -->
