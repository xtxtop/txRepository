   ...
   <div class="container-fluid">
     <div class="search-input-wrapper">
		...
		<div class="search-input-content">
           <form class="form-horizontal" name="itemSearchForm">
        <div class="seach-input-border-box">
                    ...
                    <div class="seach-input-item pull-left">
                        <span>商品分类</span>
                        <input type="text" class="form-control" name="sortName" placeholder="请输入商品分类名称">
                    </select>
                    </div>
                         <div class="seach-input-item pull-left">
                      <span>创建时间</span>
                 ...
                 <div class="seach-input-item pull-left">
            		...
            		<div class="seacher-button-content">
						...
						<button type="button" class="btn-new-type" id="itemSearchafter">确定</button>
					</div>
            </div>
         </form>
         <!-- /.box-footer -->
     ...
     <div class="row show-table-content">
      <div class="col-xs-12">
       ...
       <div class="box">
        <div class="box-body">
         <table id="itemList" class="table table-hover table-bettween-far" width="100%" border="1">
         </table>
        </div><!-- /.box-body -->
       </div><!-- /.box -->
      </div>
    ...
    $(function(){
    require.config({paths: {"item":"res/js/mall/item_list"}});
