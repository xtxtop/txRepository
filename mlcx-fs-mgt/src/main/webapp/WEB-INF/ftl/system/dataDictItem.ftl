		...
		<div class="search-input-content">
			...
			<form class="form-horizontal" name="dataDictItemSearchForm">
				<div class="seach-input-border-box">
					...
					<div class="seach-input-details dataDictCatItem close-content clearfix">
						<div class="seach-input-item pull-left over-width-item">
							<span>数据字典分类名称</span>
							<select class="form-control" name="dataDictCatCode">
					...
					<div class="seacher-button-content">
						...
						<button type="button" class="btn-new-type" id="dataDictItemSearchButton">确定</button>
					</div>
				</div>
				<!-- /.box-body -->
			</form>
...
<script type="text/javascript">
	$(function() {
		require.config({
			paths: {
				"dataDictItem": "res/js/system/dataDictItem"
			}
		});
