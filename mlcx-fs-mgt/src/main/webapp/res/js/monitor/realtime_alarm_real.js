define([],function() {
			...
			var realtimeAlarm = {
				...
				init : function() {
					...
					$('#realTime-map').css({"width":"100%","height":mapHeight-19+'px'});
...
//							}else
							if(monitor.realTimeAlarmType==2){
								myIcon = new BMap.Icon(realtimeAlarm.appPath+ '/res/img/car/car_blue.png', new BMap.Size(32, 48));
								...
								myIcon = new BMap.Icon(realtimeAlarm.appPath+ '/res/img/car/car_green.png', new BMap.Size(32, 48));
								marker = new BMap.Marker(point[i], {
									icon : myIcon
								}); // 按照地图点坐标生成标记
								//marker.setOffset(offset:30);
								...
								myIcon = new BMap.Icon(realtimeAlarm.appPath+ '/res/img/car/car_yellow.png', new BMap.Size(32, 48));
								marker = new BMap.Marker(point[i], {
									icon : myIcon
								}); // 按照地图点坐标生成标记
								//marker.setOffset(offset:30);
