     ...
     <div class="row">
      <div class="col-md-12">
       <div class="box box-default">
        ...
        <!-- /.box-header -->
        <form class="form-horizontal" name="sysOpLogSearchForm">
        <div class="box-body">
         <div class="row">
          <div class="col-md-2">操作人<input type="text" class="form-control" name="operatorUserName" placeholder=""></div>
          <div class="col-md-2">操作模快<input type="text" class="form-control" name="moduleName" placeholder=""></div>
          <div class="col-md-3">操作时间<div class="input-group">
      ...
      <div class="row">
	      <div class="col-xs-12">
	       ...
	       <div class="box">
	        <div class="box-body">
	         <table id="sysOpLogList" class="table table-bordered table-striped table-hover" width="100%">
	         </table>
	        </div><!-- /.box-body -->
	       </div><!-- /.box -->
	      </div><!-- /.col -->
