...
<div class="container-fluid">
	<div class="search-input-wrapper">
		...
		<div class="pull-right moreButtonNew" id="moreAdvertSearchafter">
			...
			<form class="form-horizontal" name="advertSearchForm">
				<div class="seach-input-border-box">
					...
					<div class="seach-input-details close-content clearfix">
							...
							<div class="seach-input-item pull-left">
								<span>活动类型</span>
								<select class="form-control" name="advertType">
					...
					<div class="seacher-button-content">
						...
						<button type="button" class="btn-new-type" id="advertSearchafter">确定</button>
					</div>
				</div>
			</form>
			<!-- /.box-footer -->
	...
	<div class="row show-table-content">
		<div class="col-xs-12">
			...
			<div class="box">
				<div class="box-body">
					<table id="advertList" class="table table-hover table-bettween-far" width="100%" border="1">
					</table>
				</div>
				<!-- /.box-body -->
			</div>
...
<script type="text/javascript">
	$(function() {
		require.config({
			paths: {
				"advert": "res/js/marketing/advert_list"
			}
		});
