   ...
   <div class="container-fluid">
     <div class="search-input-wrapper">
		...
		<div class="search-input-content">
			<form class="form-horizontal" name="depositZhimaReductionSerachForm">
	        <div class="seach-input-border-box">
	            	...
	            	<div class="seacher-button-content">
						...
						<button type="button" class="btn-new-type" id="depositZhimaReductionSearch">确定</button>
					</div>
			</div>
			</form>
		</div>
	...
	<div class="row show-table-content">
		<div class="col-xs-12">
			<!--定义操作列按钮模板-->
			<script id="depositZhimaReductionTpl" type="text/x-handlebars-template">
        		{{#each func}}
	       	...
	       	<div class="box">
				<div class="box-body">
		         	<table id="depositZhimaReductionList" class="table table-hover table-bettween-far" width="100%" border="1">
					</table>
				</div><!-- /.box-body -->
			</div><!-- /.box -->
      </div>
