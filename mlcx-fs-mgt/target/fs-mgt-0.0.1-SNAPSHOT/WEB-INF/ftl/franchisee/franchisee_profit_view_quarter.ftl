			...
			<table class="tab-table table table-border table-responsive">
				...
				<tbody class="tab-tbody">
					<tr>
						...
						<td>
							<label class="col-sm-5 control-label key"><#-- <span>*</span> -->&nbsp;&nbsp;季度：</label>
						</td>
						<td>
							<label class="control-label val">${franchiseeProfitVo.quarter}</label>
						</td>
					</tr>
					<tr>
						<td>
				...
				<tfoot class="tab-tfoot">
					<tr style="text-align: center;">
						<td colspan="4"><button type="button" id="closeFranchiseeQuarterView" class="btn-new-type-edit">
                关闭
            </button></td>
...
<script type="text/javascript">
	$(function() {
		$("#closeFranchiseeQuarterView").click(function() {
			closeTab("查看明细(按季度)");
		});
