    ...
    <div class="col-md-12">
     <div class="box box-default">
      <div class="box-header with-border">
       ...
       <form class="form-horizontal" name="wareStockInRkSearchForm"> 
       <div class="box-body">
        <div class="row">
        ...
        <div class="box-footer">
         ...
         <button type="button" class="btn btn-default pull-right btn-flat" id="wareStockInRk"  style="background:#2b94fd">确定</button>
      ...
      <div class="row">
	      <div class="col-xs-12">
	       ...
	       <div class="box">
	        ...
	        <div class="box-body">
	         <table id="wareStockInListPoId" class="table table-bordered table-striped table-hover" width="100%">
