    ...
    <div class="col-md-12 pd10">
     <div class="box box-default">
      <div class="box-header with-border">
       ...
       <form name="eportFormPackageForm">
       <div class="box-body">
		...
		<div class="col-md-6">
               <div class="box-footer">
                <button type="reset" class="btn btn-default pull-right btn-flat btnDefault" style="background:#fa6e30">清空</button>
                    <button type="button" class="btn btn-default pull-right btn-flat btnColorA" id="eportFormPackageSearch" style="background:#2b94fd">确定</button>
      ...
      <div class="row">
		...
		<div class="col-sm-12 Jq_resize_box">
			...
			<div class="mainbg">
			 	<div id="packageEportFormNs" style="width: 90%;height:400px;margin-left:5%;margin-right:5%;"></div>
			 </div>
		</div>
		<!--2楼-->
...
<script type="text/javascript">
	$(function() {
		require.config({
			paths: {
				"projectThemeCost": "res/js/reportForm/packageEportForm"
			}
		});
		require(["projectThemeCost"], function(projectThemeCost) {
			projectThemeCost.init();
		});
