   ...
   <div class="container-fluid">
       ...
       <div class="box box-default">
        ...
        <div class="box-body">
          ...
          <div class="col-md-2">
            <div class="frombg">
                <span>订单状态</span><select class="form-control" name="orderStatus">
                       ...
                       <option value="3" <#if orderStatus!=null && orderStatus==3>selected</#if> >已结束</option>
           ...
           <div class="col-md-2">
                    <div class="frombg">
                         <span>支付状态</span><select class="form-control" name="payStatus">
                           <option value="">全部</option>
                           <option value="0" <#if payStatus!=null && payStatus==0>selected</#if> >未支付</option>
		 ...
		 <div class="col-md-2">
          ...
          <!--修改-->
                    <div class="box-footer col-md-12" style='float:right;'>
     ...
     <div class="row">
      <div class="col-xs-12">
       ...
       <div class="box">
        <div class="box-body">
         <table id="orderList" class="table table-hover" width="100%">
         </table>
        </div><!-- /.box-body -->
       </div><!-- /.box -->
      </div>
