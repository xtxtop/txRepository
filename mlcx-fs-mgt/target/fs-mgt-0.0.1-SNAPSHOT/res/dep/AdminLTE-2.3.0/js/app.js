...
//        e.preventDefault();
//        debugger
//        /*增加 pushmenu 时 tab panel 自适应宽度*/
//        $("#mainConsoleTabs").css("width","100%");
//        $("#mainConsoleTabs .tabs-header").css("width","100%");
//        $("#mainConsoleTabs .tabs-wrap").css("width","100%");        
//        /*$("#mainConsoleTabs .tabs-panels").css("width","100%");*/
//        $("#mainConsoleTabs .panel").css("width","100%");
//        $("#mainConsoleTabs .panel-body").css("width","100%");
//        /*$("#mainConsoleTabs").tabs();*/
//        $(".datagrid").css("width","100%");
//        $(".datagrid-wrap").css("width","100%");
//        $(".panel-header").css("width","100%");
...
//      });
  ...
  $.AdminLTE.tree = function (menu) {
    ...
    $(document).on('click', menu + ' li a', function (e) {
      ...
      var iconEle = $this.children('i.click-name');
      //Check if the next element is a menu and is visible
      if ((checkElement.is('.treeview-menu')) && (checkElement.is(':visible'))) {
        //Close the menu
        checkElement.stop().toggle(animationSpeed, function () {
      ...
      //If the menu is not visible
        ...
        //Open the target menu and add the menu-open class
          ...
          parent_li.addClass('active').siblings('.treeview').removeClass('active');
          parent_li.siblings('.treeview').find("i.click-name").removeClass('fa-angle-up').addClass('fa-angle-down');
          //Fix the layout in case the sidebar stretches over the height of the window
